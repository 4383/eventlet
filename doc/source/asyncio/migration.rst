...
Using the :ref:`asyncio-facade-pattern` may simplify your migration. We
invite people in charge of the migration of their deliverables to have look to
this proposed pattern.
